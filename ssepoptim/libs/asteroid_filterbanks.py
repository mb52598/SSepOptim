...
class _EncDec(nn.Module):
    ...
    def __init__(self, filterbank: Filterbank, is_pinv: bool = False):
        super().__init__()
    ...
    def compute_filter_pinv(self, filters: torch.Tensor):
...
def make_enc_dec(
    ...
    """
    fb = fb_class(n_filters, kernel_size, stride=stride, sample_rate=sample_rate)
